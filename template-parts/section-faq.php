...
$items = array(
	...
	array( 'q' => 'Does the alarm still work if the Wi-Fi or power goes out?',          'a' => 'Yes. Every system we install includes a cellular backup module (LTE-M / NB-IoT) and a battery, so it keeps reporting to our monitoring station even with no internet or power — common during NYC outages.' ),
	array( 'q' => 'How fast do police respond to a monitored alarm in NYC?',            'a' => 'Every alarm is verified (camera or two-way audio) at a UL-listed central station before dispatch, so NYPD treats it as a confirmed event rather than an unverified alarm — which means faster response and fewer false-alarm fines.' ),
	...
	array( 'q' => 'Is there a long-term contract, or can I cancel anytime?',            'a' => 'No long-term trap. Buy your hardware outright or rent it, and monitoring is month-to-month — with a discount if you choose an annual agreement. Cancel with 30 days\' notice. We don\'t do 36- or 60-month bundles.' ),
);
?>
