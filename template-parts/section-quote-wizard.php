<?php
/**
 * 4-step quote wizard that replaces the simple LeadForm on the homepage.
 *
 * Step 1 — Property type (single-select)
 * Step 2 — Services (multi-select) + counters + extras
 * Step 3 — Contact (name / phone / email)
 * Step 4 — Itemized estimate + breakdown + submit
 *
...
<section class="quote-section section-paper" id="quote">
	<div class="container quote-section-inner">
		<div class="quote-section-copy">
			...
			<h2 class="display-lg" style="margin-bottom:20px"><?php esc_html_e( 'Free quote in', 'nyas' ); ?> <em><?php esc_html_e( '60 seconds.', 'nyas' ); ?></em></h2>
			<p style="font-size:17px;line-height:1.6;color:var(--fg-2);margin-bottom:28px;max-width:480px">
				<?php esc_html_e( 'Tell us about the space and we\'ll show you a price range right here — no email required to see the number. A licensed NY consultant follows up to confirm.', 'nyas' ); ?>
			</p>
			<ul class="quote-bullets">
				<li><?php nyas_icon( 'check', 16 ); ?> <?php esc_html_e( 'Itemized estimate, not a vague range', 'nyas' ); ?></li>
