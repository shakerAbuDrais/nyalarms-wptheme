...
function nyas_setup_admin_notice() {
	...
	<div class="notice notice-info" style="border-left-color: #1F4DD8;">
		...
		<p style="margin: 0 0 12px;">
			<?php esc_html_e( 'Create the core pages (Home, About, Services, Case studies, Insights + 10 service detail pages), assign templates, set the static homepage and posts page, build the primary navigation menu, and switch to pretty permalinks — all in one click.', 'nyas' ); ?>
		</p>
		<p>
...
function nyas_setup_ensure_page( $title, $slug, $template = '', $parent = 0 ) {
	// Child pages live at parent-slug/slug — look them up by full path so
	// re-runs find them instead of creating duplicates.
...
function nyas_setup_run() {
	...
	// 5. Build / update primary nav menu.
	$menu_name     = 'Primary';
